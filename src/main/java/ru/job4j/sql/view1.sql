...
insert into orders (book_id, student_id, start_data, end_data) values (1, 1,
    '2020-10-14', '2020-12-01');
insert into orders (book_id, student_id, start_data, end_data) values (3, 1,
    '2021-04-05', '2021-04-15');
insert into orders (book_id, student_id, start_data, end_data) values (5, 2,
    '2022-03-03', '2022-04-05');
insert into orders (book_id, student_id, start_data, end_data) values (4, 1,
    '2021-09-05', '2021-09-27');
insert into orders (book_id, student_id, start_data, end_data) values (2, 2,
    '2022-05-14', '2022-07-01');
insert into orders (book_id, student_id, start_data, end_data) values (6, 3,
    '2022-01-14', '2022-03-01');
insert into orders (book_id, student_id, start_data, end_data) values (7, 3,
    '2021-11-14', '2022-01-01');

create view show_students_who_have_any_book_40_days_more
    as SELECT s.name as student_name, a.name, b.name, o.end_data - o.start_data as total_days
       FROM students s
       JOIN orders o on s.id = o.student_id
       JOIN books b on o.book_id = b.id
       JOIN authors a on b.author_id = a.id
       WHERE (o.end_data - o.start_data) > 40
       ORDER BY s.name;
